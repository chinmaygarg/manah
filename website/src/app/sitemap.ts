...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: "/sectors/energy-storage", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/sectors/industrial-automation", priority: 0.7, changeFrequency: "monthly" as const },
