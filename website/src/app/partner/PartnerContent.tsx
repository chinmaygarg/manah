...
const VALUE_PROPS = [
  ...
  },
  {
    ...
    description:
      "Over ₹20,000 Cr in project pipeline with a 99.2% safety record and on-time delivery track record.",
  },
  {
    icon: Globe,
...
/* ─── Stats ─── */
const STATS = [
  { value: "₹20,000+ Cr", label: "Project Pipeline" },
...
/* ─── Partner Logos ─── */
const PARTNER_LOGOS = [
  { src: "/images/partners/logos/keltron.webp", alt: "KELTRON" },
  { src: "/images/partners/logos/cdac.webp", alt: "C-DAC" },
  { src: "/images/partners/logos/bsnl.webp", alt: "BSNL" },
  { src: "/images/partners/logos/powergrid.webp", alt: "PowerGrid Corporation of India" },
  { src: "/images/partners/logos/npcil.gif", alt: "NPCIL" },
  { src: "/images/partners/logos/eil.webp", alt: "Engineers India Limited" },
  { src: "/images/partners/logos/pfc-consulting.webp", alt: "PFC Consulting Ltd" },
  { src: "/images/partners/logos/rec-power-development.webp", alt: "REC Power Development" },
  { src: "/images/partners/logos/seci.webp", alt: "SECI" },
  { src: "/images/partners/logos/mes.webp", alt: "MES" },
  { src: "/images/partners/logos/tcil.webp", alt: "TCIL" },
  { src: "/images/partners/logos/apsfl.webp", alt: "APSFL" },
  { src: "/images/partners/logos/ap-transco.webp", alt: "AP Transco" },
  { src: "/images/partners/logos/tgtransco.webp", alt: "TGTRANSCO" },
  { src: "/images/partners/logos/nbcc.webp", alt: "NBCC (India) Limited" },
  { src: "/images/partners/logos/gril.webp", alt: "GRIL" },
  { src: "/images/partners/logos/pvr-constructions.webp", alt: "PVR Constructions" },
  { src: "/images/partners/logos/pvr-projects.webp", alt: "PVR Projects Ltd" },
  { src: "/images/partners/logos/maiwir-group.webp", alt: "MAIWIR Group" },
  { src: "/images/partners/logos/roorkee.webp", alt: "Roorkee Projects" },
  { src: "/images/partners/logos/generic.webp", alt: "Generic Engineering Construction & Projects Ltd." },
  { src: "/images/partners/logos/vere-max.webp", alt: "Vere Max" },
  { src: "/images/partners/logos/cypress-solutions.webp", alt: "Cypress Solutions" },
] as const;
        ...
        <div className="section-container py-24 md:py-32 relative z-10">
          ...
          >
            ...
            >
              ...
              <a href="/contact?subject=Partnership+Brochure+Request" className="btn-secondary">
