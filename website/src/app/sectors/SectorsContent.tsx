...
const SECTORS = [
  ...
  },
  {
    ...
    description: "Emergency response infrastructure, resilience planning, and disaster-preparedness training — the systems and skills that protect communities and critical assets.",
    color: "#DC2626",
    highlights: ["Emergency Response", "Resilience Infrastructure", "Preparedness Training", "Crisis Coordination"],
