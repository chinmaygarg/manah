...
const OPENINGS = [
  ...
  },
  {
    ...
    division: "Manah Aerospace",
    location: "Hyderabad, Telangana",
    type: "Full-time",
    experience: "3-6 years",
    description: "DGCA-licensed AME for line and base maintenance of business jets at our Begumpet MRO facility.",
  },
  {
    id: 4,
    title: "Hydrogen Process Engineer",
    department: "Engineering",
    division: "Manah Green Energy",
    location: "Bhopal / Bina, Madhya Pradesh",
    type: "Full-time",
    experience: "4-7 years",
    description: "Process engineering for electrolyzer systems and green hydrogen production at the Bina, Madhya Pradesh plant.",
  },
  {
    id: 5,
    ...
    description: "Manage electronics manufacturing operations at the 30,000 sq ft Cherlapally EMS facility — SMT assembly, testing, and quality control for Smart Meters, EV Chargers, and Defence RF Systems.",
  },
  {
    id: 6,
    title: "Reactor Safety Engineer",
    department: "Engineering",
    division: "Manah Atomic",
    location: "Hyderabad, Telangana",
    type: "Full-time",
    experience: "6-10 years",
    description: "Safety case development, probabilistic safety assessment, and AERB / IAEA compliance for Small Modular Reactor (SMR) deployment programmes.",
  },
  {
    id: 7,
    title: "ML Engineer — Agentic AI",
    department: "Technology",
    division: "Manah AI",
    location: "Hyderabad / Bangalore",
    type: "Full-time",
    experience: "3-6 years",
    description: "Design and ship agentic AI systems and LLM/SLM training pipelines for enterprise, government, and defence use cases.",
  },
  {
    id: 8,
    ...
    type: "Full-time",
    experience: "8-12 years",
    description: "Build and operate purpose-built AI data centres — high-density GPU compute, liquid cooling, and sovereign compute operations.",
  },
  {
    id: 9,
    ...
    description: "Build internal digital platforms, IoT dashboards, and AI applications for project monitoring and asset management.",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    division: "Manah Holdings",
    location: "Hyderabad, Telangana",
    type: "Full-time",
    experience: "5-8 years",
    description: "Drive HR strategy, talent acquisition, and culture-building across all six Manah divisions.",
  },
];
    ...
    <main>
      ...
      <section className="relative bg-manah-navy text-white overflow-hidden -mt-20 pt-20">
        <video
          ...
          playsInline
          preload="auto"
          poster="/images/careers/careers_hero.webp"
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-3 mt-2 text-body-sm text-manah-gray-500">
                        ...
                        <span className="flex items-center gap-1 text-manah-gold">{job.division}</span>
