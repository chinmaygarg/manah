...
const DIVISION_IMAGES: Record<string, { hero: string; detail: string; video?: string; videoMobile?: string }> = {
  ...
  aerospace: {
    hero: "/images/divisions/manah_aerospace_hero.webp",
    detail: "/images/divisions/manah_aerospace_detail.webp",
    video: "/videos/divisions/aerospace_reel-720p.mp4",
    videoMobile: "/videos/divisions/aerospace_reel-480p.mp4",
  },
  "green-energy": {
    hero: "/images/divisions/green_energy_hero.webp",
    detail: "/images/divisions/green_energy_hydrogen.webp",
    video: "/videos/divisions/green_energy_reel-720p.mp4",
    videoMobile: "/videos/divisions/green_energy_reel-480p.mp4",
  },
  atomic: {
    hero: "/images/divisions/manah_atomic_hero.webp",
    detail: "/images/divisions/manah_atomic_detail.webp",
    video: "/videos/divisions/atomic_reel-720p.mp4",
    videoMobile: "/videos/divisions/atomic_reel-480p.mp4",
  },
  ai: {
    hero: "/images/divisions/manah_ai_hero.webp",
    detail: "/images/divisions/manah_ai_detail.webp",
    video: "/videos/divisions/ai_reel-720p.mp4",
    videoMobile: "/videos/divisions/ai_reel-480p.mp4",
  },
  investments: {
    hero: "/images/divisions/manah_investments_hero.webp",
    detail: "/images/divisions/manah_investments_detail.webp",
