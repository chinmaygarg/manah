...
const PARTNERS = [
  { name: "KELTRON", logo: "/images/partners/logos/keltron.webp" },
  { name: "C-DAC", logo: "/images/partners/logos/cdac.webp" },
  { name: "BSNL", logo: "/images/partners/logos/bsnl.webp" },
  { name: "PowerGrid Corporation of India", logo: "/images/partners/logos/powergrid.webp" },
  { name: "NPCIL", logo: "/images/partners/logos/npcil.gif" },
  { name: "Engineers India Limited", logo: "/images/partners/logos/eil.webp" },
  { name: "PFC Consulting Ltd", logo: "/images/partners/logos/pfc-consulting.webp" },
  { name: "REC Power Development", logo: "/images/partners/logos/rec-power-development.webp" },
  { name: "SECI - Solar Energy Corporation of India", logo: "/images/partners/logos/seci.webp" },
  { name: "Military Engineering Service (MES)", logo: "/images/partners/logos/mes.webp" },
  { name: "TCIL", logo: "/images/partners/logos/tcil.webp" },
  { name: "APSFL - Andhra Pradesh State FiberNet Ltd.", logo: "/images/partners/logos/apsfl.webp" },
  { name: "AP Transco", logo: "/images/partners/logos/ap-transco.webp" },
  { name: "TGTRANSCO", logo: "/images/partners/logos/tgtransco.webp" },
  { name: "NBCC (India) Limited", logo: "/images/partners/logos/nbcc.webp" },
  { name: "GRIL", logo: "/images/partners/logos/gril.webp" },
  { name: "PVR Constructions", logo: "/images/partners/logos/pvr-constructions.webp" },
  { name: "PVR Projects Ltd", logo: "/images/partners/logos/pvr-projects.webp" },
  { name: "MAIWIR Group", logo: "/images/partners/logos/maiwir-group.webp" },
  { name: "Roorkee Projects", logo: "/images/partners/logos/roorkee.webp" },
  { name: "Generic Engineering Construction & Projects Ltd.", logo: "/images/partners/logos/generic.webp" },
  { name: "Vere Max", logo: "/images/partners/logos/vere-max.webp" },
  { name: "Cypress Solutions", logo: "/images/partners/logos/cypress-solutions.webp" },
] as const;
