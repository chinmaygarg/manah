...
export const NAVIGATION: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Defence", href: "/sectors/defence", description: "Tactical comms, radar, EW, and weapon electronics", image: "/images/sectors/defence_electronics.webp", featured: true },
      ...
      { label: "Renewables", href: "/sectors/renewable-energy", description: "Utility-scale solar, wind, and hybrid plants", image: "/images/sectors/renewable_energy.webp", featured: true },
      { label: "Disaster Management", href: "/sectors/disaster-management", description: "Training, response, and resilience infrastructure", image: "/images/sectors/disaster_management.webp" },
    ],
  },
  {
    label: "Projects",
...
export const FOOTER_LINKS = {
  ...
  sectors: [
    ...
    { label: "BESS / SCADA", href: "/sectors/bess-scada" },
