...
SECTOR_IMAGES = [
    ...
    # NOTE: bess_scada + disaster_management sector images are generated by
    # generate_new_sectors.py (Replicate / FLUX 2 Pro) — the Google Gemini
    # image quota was exhausted at the time of the deck content sync.
]
